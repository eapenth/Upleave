                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class='breadcrumb-header'>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="employee.php"
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-content">
                                        <div class="card-body">
                                            <form class="form" name="submit" action="#" method="POST"
                                                        ...
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <fieldset class="form-group">
                                                                    <select class="form-select custom-width" name="ltype"
                                                                        id="leaveType" onblur=>
                                                ...
                                                <div class="row" id="additionalOptionsRow" style="display: none;">
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <fieldset class="form-group">
                                                                    <select class="form-select custom-width" name="session"
                                                            ...
                                                            <span id="additionalOptionsValidation"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="date" class="form-control" name="fromd"
                                                                    id="from-date" min="2024-02-19"
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="date" class="form-control" name="tod"
                                                                    id="to-date" onkeydown="return false">
                                                                <div class="form-control-icon">
                                                                    <i class="fa fa-calendar"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <textarea class="form-control" required name="reason"
                                                                id="reason" rows="4" style="width: 70%; max-width: 70%;"
                                                                required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-12 d-flex justify-content-end">
                                                        <button type="submit" name="submit"
                                                            class="btn btn-primary me-1 mb-1">Submit Request</button>
                                                    </div>
                                                </div>
                                                <span style="color: green;">
                                                    <?php echo $leaveSuccessMessage; ?>
                                                </span>
                                                <span style="color: red;">
                                                    <?php echo $leaveFailureMessage; ?>
                                                </span>
                                            </form>
