...
require 'E:/Xampp/htdocs/u/vendor/autoload.php';
        ...
        if ($row = $result->fetch_assoc()) {
            ...
            if ($conn->query($updateSql)==true) {
                ...
                try {
                    ...
                    $mail->Username   = 'tojeemani8@gmail.com'; // SMTP username
                    $mail->Password   = 'untv kgri uzri luci'; // SMTP password
                    ...
                    $mail->isHTML(true);
                    // Recipients
                    $mail->setFrom('reeco.recycle@gmail.com', 're-eco');
