 ...
 if(isset($_FILES['duty_order']) && $_FILES['duty_order']['error'] === UPLOAD_ERR_OK) {
    ...
    $sql = "INSERT INTO tbl_leave (emp_id, l_id,session,st_date, to_date, document,reason,status,appliedtime,daydiff) VALUES ('$empid', '$lid', '$session', '$fromd', '$tod', '$fileDestination','$reason','0','$currentDateTime','$daysDiff ');";
        ...
        if($conn->query($sql) == true){
            ...
            $row =$req->fetch_assoc();
            $reqid = $row['req_id'];
            $idql = "insert into tbl_docs (req_id,doc1,status)values('$reqid','$fileDestination','0');";
            if($conn->query($idql)){
            }
    ...
    <div class="row">
        <div class="col-md-6 col-6">
            <div class="form-group has-icon-left">
                ...
                <input type="Date" class="form-control" name="assignment_duty" id="assignment-duty" style="width: 490px;"onkeydown="return false"  oninput="validateAssignmentDuty()">
                <span id="assignmentDutyValidation" style="color: red;"></span>
            </div>
        </div>
        <div class="col-md-6 col-6">
            <div class="form-group has-icon-left">
                <label for="additional-options">Select Reason</label>
                <div class="position-relative">
                    <fieldset class="form-group">
                        <select class="form-select custom-width" name="reason1" id="additionalOptions" onchange="toggleReasonTextArea()">
    ...
    <div class="row">
        <div class="col-md-6 col-12">
            <div class="form-group has-icon-left" id="fileUpload">
                <label for="file-upload">Upload Proof</label>
